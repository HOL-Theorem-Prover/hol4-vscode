...
val _ = print $ printFragsAsE s [l]; *)
val ls = sliceTacticBlock a b false (0, size s) tac;
(* val _ = PolyML.print $ map unlinearize ls; *)
val _ = print $ printFragsAsE s ls;
in () end;
(*
 (go 0 299) ();
*)
...
(*
Induct_on [QUOTE " (*#loc 32 16*)ins"] \\ gvs [eval_io_def,FORALL_PROD]
*)
